...
const latamHistory = [
  "La historia de Pink Boots en Latinoamerica comenzo en Peru, cuando Megan Garity —una cervecera estadounidense— fundo Pink Boots Peru, sembrando la semilla de la comunidad en la region. La organizacion continuo su camino en manos de Andrea Huertas, quien siguio impulsando el movimiento en el pais.",
  "Pink Boots Latin America como organizacion regional nacio con la vision de Silvia y Ericka Otero, quienes la formalizaron juntas con el objetivo de que no solamente las mujeres peruanas pudiesen obtener el beneficio de la educacion en bebidas fermentadas, sino extenderlo por toda Latinoamerica —con educacion de alto nivel en habla hispana. Ericka Otero continuo liderandola, buscando impulsar la educacion, la colaboracion, el crecimiento profesional y la sororidad entre sus integrantes.",
  "Con Panama como sede del chapter padre de Latinoamerica, la red sumo integrantes en Mexico (con Viviana Lopez en Cuernavaca), Chile (con Veronica Carrasco en Santiago) y Argentina (con Cristina Saez en Buenos Aires).",
  "En 2026 nacio un nuevo hito: el sub-capitulo Pink Boots Latam / Puerto Rico, conformado por 21 integrantes y liderado por Keishla Torres, organizo el primer Collaboration Brew Day LATAM en marzo y fue oficializado como sub-capitulo en mayo. Ademas, Silvia y Ericka Otero fueron seleccionadas como juezas del World Beer Cup 2026. De Mexico a la Patagonia, seguimos creciendo con una sola pasion: la cerveza.",
];
