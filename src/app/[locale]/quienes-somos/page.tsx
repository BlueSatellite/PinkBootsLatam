...
const introParagraphs = [
  ...
  "Pink Boots LATAM nace como una comunidad regional para conectar, apoyar y visibilizar a las mujeres de Latinoamérica vinculadas a la industria cervecera y de bebidas fermentadas. Creada en 2023, busca impulsar la educación, la colaboración, el crecimiento profesional y la sororidad entre sus integrantes, creando oportunidades que fortalezcan el papel de la mujer latinoamericana dentro de la industria. Su objetivo: extender por toda la región una educación de alto nivel en habla hispana.",
...
function ChapterCard({ chapter, featured = false }: { chapter: (typeof officialChapters)[number]; featured?: boolean }) {
  return (
    <div
      className={`rounded-xl border bg-white p-6 transition-all hover:shadow-sm ${featured ? "border-2 border-[var(--color-pink-200)] shadow-xs" : "border-[var(--color-border-default)] hover:border-[var(--color-pink-200)]"
        }`}
    >
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 rounded-xl border border-[var(--color-border-light)] bg-white p-6 shadow-xs sm:p-8">
            ...
            <div className="mt-5 pt-4 border-t border-gray-100 flex flex-wrap items-center justify-between gap-4">
              <p className="text-xs text-[var(--color-text-muted)]">
                ¿Te gustaría impulsar o abrir un capítulo en tu ciudad?
              </p>
              <a
