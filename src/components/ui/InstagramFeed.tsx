    ...
    <section className="bg-[var(--color-surface-alt)] py-16 sm:py-20">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-base text-[var(--color-text-secondary)]">
          ...
          {" "}&mdash; 2.500+ seguidoras, 300+ publicaciones
        </p>
        <div className="mt-8 grid grid-cols-3 gap-3 sm:grid-cols-4 lg:grid-cols-6">
          {Array.from({ length: 6 }).map((_, i) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative aspect-square overflow-hidden rounded-lg bg-[var(--color-pink-100)] transition-transform hover:scale-105"
            >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-6 inline-flex items-center gap-2 rounded-full bg-[var(--color-pink-brand)] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[var(--color-pink-600)]"
        >
